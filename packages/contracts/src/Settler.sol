...
// TODO: setters should be one function with a flag to check if it's an add or remove
// TODO: rename filling to taken
...
contract Settler is Ownable, Nonces, ISettler {
  ...
  AggregatorV3Interface public immutable TCAP_PRICE_ORACLE;
  ...
  constructor(
    ...
    address _GUARDIAN,
    IERC20 _TOKEN,
    AggregatorV3Interface _TCAP_PRICE_ORACLE,
    ...
    GUARDIAN = _GUARDIAN;
    TOKEN = _TOKEN;
    TCAP_PRICE_ORACLE = _TCAP_PRICE_ORACLE;
  ...
  function createOrder(uint256 _minReceived, address _inputToken, uint256 _amount) external onlyAllowedInstitutions {
  ...
  function cancelOrder(int256 _orderId) external onlyAllowedInstitutions {
